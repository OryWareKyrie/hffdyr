...
- [MOLDELO DE SAÍDA](#output-template)
- [SELEÇÃO DE FORMATO](#format-selection)
- [SELEÇÃO DE VIDEO](#video-selection)
- [FAQ](#faq)
- [INSTRUÇÕES PARA O DESENVOLVEDOR](#developer-instructions)
- [EMBARCANDO YOUTUBE-DL](#embedding-youtube-dl)
- [BUGS](#bugs)
- [DIREITO AUTORAL](#copyright)

# INSTALAÇÃO

Para instalá-lo imediatamente para todos os usuários do UNIX (Linux, macOS, etc.), digite:
